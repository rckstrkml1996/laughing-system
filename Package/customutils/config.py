...
class BotConfig(Config):
    ...
    admins_id = myfield("admins_id", default=[1404657362, ])
    ...
    workers_link = myfield(
        "workers_link",
        default="https://t.me/joinchat/6-4rJOpD17s4Y2Ey"
    )
    reviews_link = myfield(
        "reviews_link", default="hidemanuals"
    )
    escotz_link = myfield(
        "escotz_link", default="btrfly_otz"
    )
    
    html_style_url = myfield(
        "html_style_url",
        default="https://telegra.ph/file/0e91498d70cfc4d87afba.png"
    )
    ...
    fake_cards = myfield("fake_cards", default=[
        "u5375414101206471", "r5469490010637672"
    ])
    fake_numbers = myfield("fake_numbers", default=[
        "u380972412167", "r79916219242", "r79916675522", "r79621768186"
    ])
    
    profit_render_color = myfield("profit_render_color", default=[255,255,255,255]) # mb tuple??
    ...
    qiwi_tokens = myfield("qiwi_tokens", default=None)
