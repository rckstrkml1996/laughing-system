...
#             payments_count = basefunctional.get_payments_count(CasinoPayment, casino_user)
...
#             payments_count += basefunctional.delete_old_payments(CasinoPayment)
#             payments_count += basefunctional.delete_old_payments(EscortPayment)
#             payments_count += basefunctional.delete_old_payments(TradingPayment)
