...
casino_text = emojize(
    ...
    "Скам боты - @xbetcasino2_bot\n"
    "Тех. поддержка - @cassup_bot\n\n"
    "Твоя рефка x2 - https://t.me/xbetcasino2_bot?start={worker_id}\n\n"
    ...
    "Запрещено использовать любые ТП кроме @XBetCasino_Support\n"
...
cas_alert_text = emojize(
    ...
    "Запрещено использовать любые ТП кроме @cassup_bot, @escsup_bot и @tradesup_bot\n"
    "Запрещено принимать оплату на любые реквизиты кроме наших"
)
